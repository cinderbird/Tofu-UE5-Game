...
public:
	...
	TObjectPtr<UKausInventoryItemInstance> Item = nullptr;
};
...
public:
	...
	static void AddPickupToInventory(UKausInventoryManagerComponent* InventoryComponent, TScriptInterface<IPickupable> Pickup);
};
