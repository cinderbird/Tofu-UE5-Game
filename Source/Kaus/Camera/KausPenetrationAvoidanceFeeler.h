...
#include "KausPenetrationAvoidanceFeeler.generated.h"

/**
 * Struct defining a feeler ray used for camera penetration avoidance.
 */
USTRUCT()
struct FKausPenetrationAvoidanceFeeler
{
	GENERATED_BODY()
	...
	FKausPenetrationAvoidanceFeeler()
	...
	FKausPenetrationAvoidanceFeeler(const FRotator& InAdjustmentRot,
