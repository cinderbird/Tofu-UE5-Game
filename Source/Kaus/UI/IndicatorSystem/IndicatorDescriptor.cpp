...
void UIndicatorDescriptor::SetIndicatorManagerComponent(UKausIndicatorManagerComponent* InManager)
{
...
{
	if (UKausIndicatorManagerComponent* Manager = ManagerPtr.Get())
	{
