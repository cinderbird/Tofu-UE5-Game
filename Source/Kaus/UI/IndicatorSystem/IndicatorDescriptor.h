...
class KAUS_API UIndicatorDescriptor : public UObject
{
	GENERATED_BODY()
...
public:
	UKausIndicatorManagerComponent* GetIndicatorManagerComponent() { return ManagerPtr.Get(); }
	void SetIndicatorManagerComponent(UKausIndicatorManagerComponent* InManager);
...
private:
	...
	UPROPERTY()
	TWeakObjectPtr<UKausIndicatorManagerComponent> ManagerPtr;
