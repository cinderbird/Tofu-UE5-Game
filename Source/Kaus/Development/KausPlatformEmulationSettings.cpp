#include "KausPlatformEmulationSettings.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(KausPlatformEmulationSettings)

#define LOCTEXT_NAMESPACE "KausCheats"

UKausPlatformEmulationSettings::UKausPlatformEmulationSettings()
{
}

FName UKausPlatformEmulationSettings::GetCategoryName() const
{
	return FApp::GetProjectName();
}

FName UKausPlatformEmulationSettings::GetPretendBaseDeviceProfile() const
{
	return PretendBaseDeviceProfile;
}

FName UKausPlatformEmulationSettings::GetPretendPlatformName() const
{
	return PretendPlatform;
}

#if WITH_EDITOR
void UKausPlatformEmulationSettings::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void UKausPlatformEmulationSettings::PostReloadConfig(FProperty* PropertyThatWasLoaded)
{
...
void UKausPlatformEmulationSettings::PostInitProperties()
{
...
void UKausPlatformEmulationSettings::OnPlayInEditorStarted() const
{
...
void UKausPlatformEmulationSettings::ApplySettings()
{
...
void UKausPlatformEmulationSettings::ChangeActivePretendPlatform(FName NewPlatformName)
{
...
TArray<FName> UKausPlatformEmulationSettings::GetKnownPlatformIds() const
{
...
TArray<FName> UKausPlatformEmulationSettings::GetKnownDeviceProfiles() const
{
	TArray<FName> Results;
...
void UKausPlatformEmulationSettings::PickReasonableBaseDeviceProfile()
{
