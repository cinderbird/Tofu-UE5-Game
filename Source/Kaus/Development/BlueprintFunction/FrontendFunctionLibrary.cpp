...
#include "Development/FrontendDeveloperSettings.h"

TSoftClassPtr<UKausActivatableWidget> UFrontendFunctionLibrary::GetFrontendSoftWidgetClassByTag(UPARAM(meta = (Categories = "Frontend.Widget")) FGameplayTag InWidgetTag)
{	
