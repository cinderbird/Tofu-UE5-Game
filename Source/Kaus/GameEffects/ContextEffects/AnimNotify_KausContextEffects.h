...
#include "AnimNotify_KausContextEffects.generated.h"

/**
 *
 */
USTRUCT(BlueprintType)
struct KAUS_API FKausContextEffectAnimNotifyVFXSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct KAUS_API FKausContextEffectAnimNotifyAudioSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct KAUS_API FKausContextEffectAnimNotifyTraceSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct KAUS_API FKausContextEffectAnimNotifyPreviewSettings
{
	GENERATED_BODY()
	...
	// Preview Library
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Preview, meta = (AllowedClasses = "/Script/Kaus.KausContextEffectsLibrary"))
...
class KAUS_API UAnimNotify_KausContextEffects : public UAnimNotify
{
	GENERATED_BODY()

public:
	UAnimNotify_KausContextEffects();
	...
	// Scale to spawn the particle system at
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AnimNotify", meta = (ExposeOnSpawn = true))
	FKausContextEffectAnimNotifyVFXSettings VFXProperties;

	// Scale to spawn the particle system at
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AnimNotify", meta = (ExposeOnSpawn = true))
	FKausContextEffectAnimNotifyAudioSettings AudioProperties;
	...
	FKausContextEffectAnimNotifyTraceSettings TraceProperties;
	...
	FKausContextEffectAnimNotifyPreviewSettings PreviewProperties;
#endif
