...
#include "KausContextEffectsInterface.generated.h"
 ...
 */
 ...
 class KAUS_API UKausContextEffectsInterface : public UInterface
 {
	 GENERATED_BODY()

 };

 class KAUS_API IKausContextEffectsInterface : public IInterface
 {
	 GENERATED_BODY()
