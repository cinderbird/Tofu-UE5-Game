...
#include "KausContextEffectComponent.generated.h"
...
class KAUS_API UKausContextEffectComponent : public UActorComponent, public IKausContextEffectsInterface
{
	GENERATED_BODY()

public:	
	// Sets default values for this component's properties
	UKausContextEffectComponent();
...
public:
	...
	UPROPERTY(EditAnywhere)
	TSet<TSoftObjectPtr<UKausContextEffectsLibrary>> DefaultContextEffectsLibraries;

	UFUNCTION(BlueprintCallable)
	void UpdateEffectContexts(FGameplayTagContainer NewEffectContexts);

	UFUNCTION(BlueprintCallable)
	void UpdateLibraries(TSet<TSoftObjectPtr<UKausContextEffectsLibrary>> NewContextEffectsLibraries);
...
private:
	...
	UPROPERTY(Transient)
	TSet<TSoftObjectPtr<UKausContextEffectsLibrary>> CurrentContextEffectsLibraries;
