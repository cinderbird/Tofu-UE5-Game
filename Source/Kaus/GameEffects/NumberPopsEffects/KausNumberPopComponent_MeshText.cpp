...
UKausNumberPopComponent_MeshText::UKausNumberPopComponent_MeshText(const FObjectInitializer& ObjectInitializer)
...
void UKausNumberPopComponent_MeshText::AddNumberPop(const FKausNumberPopRequest& NewRequest)
{
...
void UKausNumberPopComponent_MeshText::ReleaseNextComponents()
{
	UWorld* LocalWorld = GetWorld();
	check(LocalWorld);
...
FLinearColor UKausNumberPopComponent_MeshText::DetermineColor(const FKausNumberPopRequest& Request) const
{
	for (UKausDamagePopStyle* Style : Styles)
	{
...
UStaticMesh* UKausNumberPopComponent_MeshText::DetermineStaticMesh(const FKausNumberPopRequest& Request) const
{
	for (UKausDamagePopStyle* Style : Styles)
	{
...
void UKausNumberPopComponent_MeshText::SetMaterialParameters(const FKausNumberPopRequest& Request, FTempNumberPopInfo& NewDamageNumberInfo, const FTransform& CameraTransform, const FVector& NumberLocation)
{
