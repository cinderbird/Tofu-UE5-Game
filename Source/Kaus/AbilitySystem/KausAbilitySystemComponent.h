...
#include "Abilities/KausGameplayAbility.h"
...
KAUS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Gameplay_AbilityInputBlocked);
...
public:
	...
	void SetTagRelationshipMapping(UKausAbilityTagRelationshipMapping* NewMapping);
